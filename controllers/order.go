...
func (order_controller OrderController) Order(w http.ResponseWriter, r *http.Request) {
...
func (order_controller OrderController) SaveOrder(w http.ResponseWriter, r *http.Request) {
