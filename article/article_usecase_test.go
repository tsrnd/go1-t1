...
func TestFetchInUsecase(t *testing.T) {
	mockArticleRepo := new(RepositoryMock)
...
func TestStoreInUsecase(t *testing.T) {
	...
	mockArticleRepo.On("GetByTitle", mock.AnythingOfType("string")).Return(nil, ErrorNotFound)
...
func TestDeleteInUsecase(t *testing.T) {
	...
	mockArticleRepo.On("GetByID", mock.AnythingOfType("int64")).Return(&mockArticle, ErrorNotFound)
	defer mockArticleRepo.AssertCalled(t, "GetByID", mock.AnythingOfType("int64"))
