...
// UsecaseMock is an autogenerated mock type for the AUsecase type
type UsecaseMock struct {
	mock.Mock
}

// Delete provides a mock function with given fields: id
func (_m *UsecaseMock) Delete(id int64) (bool, error) {
	ret := _m.Called(id)
...
func (_m *UsecaseMock) Fetch(cursor string, num int64) ([]*Article, string, error) {
...
func (_m *UsecaseMock) GetByID(id int64) (*Article, error) {
	ret := _m.Called(id)
...
func (_m *UsecaseMock) GetByTitle(title string) (*Article, error) {
	ret := _m.Called(title)
...
func (_m *UsecaseMock) Store(_a0 *Article) (*Article, error) {
	ret := _m.Called(_a0)
...
func (_m *UsecaseMock) Update(ar *Article) (*Article, error) {
	ret := _m.Called(ar)
