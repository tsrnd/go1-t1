            ...
            <div class="row">
                <div class="col-md-3 col-sm-4">
                    <div class="footer-contact">
                        <img src="/static/frontend/img/logo-white.png" alt="">
                        ...
                        <div class="twitter-feed">
                            <div class="twitter-article">
                                <div class="twitter-img">
                                    <a href="#">
                                        <img src="/static/frontend/img/twitter/twitter-1.png" alt="">
                                    </a>
                                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="payment-icon">
                        <img src="/static/frontend/img/payment.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="modal-product">
                            <div class="product-images">
                                <div class="main-image images">
                                    <img alt="" src="/static/frontend/img/product/quick-view.jpg">
                                </div>
                            </div>
