            ...
            <div class="col-sm-6">
                <div class="single-product-img">
                    <div class="single-pro-main-image">
                        <a href="#"><img id="optima_zoom" src="/public/img/product/" data-zoom-image="img/product/" alt="optima"/></a>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                    ...
                    <div class="cart-item">
                        <div class="single-cart">
                            <div class="cart-plus-minus">
                                <label>Qty: </label>
                                <input class="cart-plus-minus-box quantity" type="text" name="qtybutton" value="0">
                            </div>
                                <input class="id" type="hidden" value=""> </input>
                                <input class="name" type="hidden" value=""> </input>
                                <input class="image" type="hidden" value=""> </input>
                                <input class="price" type="hidden" value=""> </input>
                    ...
                    <div class="single-product">
                        <div class="product-img">
                            <a href="/single-product/">
                                <img src="/public/img/product/" alt="" class="first-img">
                            </a>
                        </div>
                        <div class="product-price">
                            <div class="product-name">
                                <a href="/single-product/" title=""></a>
                            </div>
                            <div class="price-rating">
                                <span>$</span>
                            </div>
