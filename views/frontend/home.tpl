...
<div class="slider-area home2">
    <div class="bend niceties preview-2">
        <div id="nivoslider" class="slides">
            <img src="/static/frontend/img/slider/slider-3.jpg" alt="" title="#slider-direction-1"  />
            <img src="/static/frontend/img/slider/slider-4.jpg" alt="" title="#slider-direction-2"  />
        </div>
        <!-- direction 1 -->
        <div id="slider-direction-1" class="t-cn slider-direction">
            ...
            <div class="slider-content t-lfl s-tb slider-1">
                <div class="title-container s-tb-c title-compress">
                    <img src="/static/frontend/img/slider/slider-logo.png" alt="">
            ...
            <div class="col-sm-4">
                <div class="single-service">
                    <div class="sirvice-img">
                        <img src="/static/frontend/img/service/icon-1.png" alt="">
                    </div>
        ...
        <div class="row">
                ...
                <div class="single-home2-blog-post">
                    <div class="blog-img">
                        <a href="blog-details.html">
                            <img src="/static/frontend/img/blog/5.jpg" alt="">
            ...
            <div class="col-sm-6">
                <div class="single-home2-blog-post">
                    <div class="blog-img">
                        <a href="blog-details.html">
                            <img src="/static/frontend/img/blog/6.jpg" alt="">
                            <i class="fa fa-file-photo-o"></i>
                        </a>
                    </div>
                    <div class="blog-content">
